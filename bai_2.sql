...
YEAR(NGAYGIAOHANG) = 2017 AND MAKHUVUCGIAOHANG = 'KV004';
GO
...
SELECT DIACHIGIAOHANG, MADONHANGGIAOHANG,MAKHACHHANG,TENKHACHHANG, 
PHUONGTHUCTHANHTOAN, TRANGTHAIGIAOHANG FROM DONHANGGIAOHANG 
JOIN KHACHHANG ON DONHANGGIAOHANG.MAKHACHHANG = KHACHHANG.MAKHACHHANG;
GO

--CAU 9: liet ke nhan vien giao hang la nu giao hang khac nhau o khu vuc "thanh khe" 
SELECT * FROM DONHANGGIAOHANG;
GO
SELECT * FROM THANHVIENGIAOHANG
JOIN DONHANGGIAOHANG 
